...
*************************************************************$ */
#ifndef _Sub_Doors_Motion_Monitoring_H_
#define _Sub_Doors_Motion_Monitoring_H_
...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_bool /* MTC_doors_anomaly/, doors_anomaly/ */ doors_anomaly;
  /* -----------------------   local probes  ------------------------- */
  Result_MTC /* @17/MTC_ALL1/ */ MTC_ALL1_Sub_Doors_Motion_Monitoring_PATHS1_MTC_OBS_1_Sub_Doors_Motion_Monitoring_MTC_open_close_EV_last_MTC_INST_1;
  Result_MTC /* @15/MTC_ALL1/ */ _1_MTC_ALL1_Sub_Doors_Motion_Monitoring_PATHS6_MTC_OBS_1;
  Result_MTC /* @14/MTC_ALL1/ */ _2_MTC_ALL1_Sub_Doors_Motion_Monitoring_PATHS5_MTC_OBS_1;
  Result_MTC /* @13/MTC_ALL1/ */ _3_MTC_ALL1_Sub_Doors_Motion_Monitoring_PATHS4_MTC_OBS_1;
  Result_MTC /* @12/MTC_ALL1/ */ _4_MTC_ALL1_Sub_Doors_Motion_Monitoring_PATHS3_MTC_OBS_1;
  ...
  Result_MTC /* @5/MTC_ALL1/ */ _5_MTC_ALL1_Sub_Doors_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Doors_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* MTC_open_close_EV/ */ MTC_open_close_EV;
  ...
  kcg_int32 /* @9/_/v3/ */ v3_times_1_Sub_Doors_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32;
  kcg_int32 /* @5/v3/ */ v3_Sub_Doors_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Doors_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;
  kcg_bool init;
  kcg_bool init6;
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_LATCHALL02_MTC /* @17/MTC_ALL1=(MTC::LATCHALL02)/ */ Context_LATCHALL02_MTC_Sub_Doors_Motion_Monitoring_PATHS1_MTC_OBS_1_Sub_Doors_Motion_Monitoring_MTC_open_close_EV_last_MTC_INST_1;
  outC_LATCHALL03_MTC /* @15/MTC_ALL1=(MTC::LATCHALL03)/ */ Context_LATCHALL03_MTC_Sub_Doors_Motion_Monitoring_PATHS6_MTC_OBS_1;
  outC_LATCHALL03_MTC /* @14/MTC_ALL1=(MTC::LATCHALL03)/ */ _7_Context_LATCHALL03_MTC_Sub_Doors_Motion_Monitoring_PATHS5_MTC_OBS_1;
  outC_LATCHALL03_MTC /* @13/MTC_ALL1=(MTC::LATCHALL03)/ */ _8_Context_LATCHALL03_MTC_Sub_Doors_Motion_Monitoring_PATHS4_MTC_OBS_1;
  outC_LATCHALL03_MTC /* @12/MTC_ALL1=(MTC::LATCHALL03)/ */ _9_Context_LATCHALL03_MTC_Sub_Doors_Motion_Monitoring_PATHS3_MTC_OBS_1;
  ...
  outC_LATCHALL04_MTC /* @5/MTC_ALL1=(MTC::LATCHALL04)/ */ Context_LATCHALL04_MTC_Sub_Doors_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Doors_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;
...
} outC_Sub_Doors_Motion_Monitoring;

/* ===========  node initialization and cycle functions  =========== */
/* Sub_Doors_Motion_Monitoring/ */
extern void Sub_Doors_Motion_Monitoring(
  /* _L4/, open_close_EV/ */
...
extern void Sub_Doors_Motion_Monitoring_reset(
  outC_Sub_Doors_Motion_Monitoring *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Sub_Doors_Motion_Monitoring_init(
  outC_Sub_Doors_Motion_Monitoring *outC);
...
/*
  ...
  @9: @4/(times#1)
  @10: (MTCEx::MTC_Instrumenters::Sub_Doors_Motion_Monitoring_Sub_Doors_Motion_Monitoring_NO_ANOMALY_1_MTC_INST#1)
  @11: (MTCEx::MTC_Instrumenters::Sub_Doors_Motion_Monitoring_MTC_doors_anomaly_def_MTC_INST#1)
...
#endif /* _Sub_Doors_Motion_Monitoring_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6 (build i15) ***********
** Sub_Doors_Motion_Monitoring.h
** Generation date: 2020-02-07T16:18:02
*************************************************************$ */
