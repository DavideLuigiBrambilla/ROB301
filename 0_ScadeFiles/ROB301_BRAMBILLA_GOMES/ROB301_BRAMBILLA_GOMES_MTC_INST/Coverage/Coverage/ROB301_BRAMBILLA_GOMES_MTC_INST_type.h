#ifndef ROB301_BRAMBILLA_GOMES_MTC_INST_TYPES_CONVERSION
#define ROB301_BRAMBILLA_GOMES_MTC_INST_TYPES_CONVERSION
...
extern int set_Result_MTC_default_value(void *pValue);
extern SimTypeUtils _Type_Result_MTC_Utils;

/****************************************************************
 ** SSM_ST_State_Machine_Extend_Gear 
 ****************************************************************/
extern int SSM_ST_State_Machine_Extend_Gear_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_SSM_ST_State_Machine_Extend_Gear_string(const char *str, char **endptr);
extern int string_to_SSM_ST_State_Machine_Extend_Gear(const char *str, void *pValue, char **endptr);
extern int is_SSM_ST_State_Machine_Extend_Gear_double_conversion_allowed();
extern int SSM_ST_State_Machine_Extend_Gear_to_double(const void *pValue, double *nValue);
extern int is_SSM_ST_State_Machine_Extend_Gear_long_conversion_allowed();
extern int SSM_ST_State_Machine_Extend_Gear_to_long(const void *pValue, long *nValue);
extern void compare_SSM_ST_State_Machine_Extend_Gear(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_SSM_ST_State_Machine_Extend_Gear_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_SSM_ST_State_Machine_Extend_Gear_default_value(void *pValue);
extern SimTypeUtils _Type_SSM_ST_State_Machine_Extend_Gear_Utils;

/****************************************************************
 ** SSM_TR_State_Machine_Extend_Gear 
 ****************************************************************/
extern int SSM_TR_State_Machine_Extend_Gear_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_SSM_TR_State_Machine_Extend_Gear_string(const char *str, char **endptr);
extern int string_to_SSM_TR_State_Machine_Extend_Gear(const char *str, void *pValue, char **endptr);
extern int is_SSM_TR_State_Machine_Extend_Gear_double_conversion_allowed();
extern int SSM_TR_State_Machine_Extend_Gear_to_double(const void *pValue, double *nValue);
extern int is_SSM_TR_State_Machine_Extend_Gear_long_conversion_allowed();
extern int SSM_TR_State_Machine_Extend_Gear_to_long(const void *pValue, long *nValue);
extern void compare_SSM_TR_State_Machine_Extend_Gear(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_SSM_TR_State_Machine_Extend_Gear_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_SSM_TR_State_Machine_Extend_Gear_default_value(void *pValue);
extern SimTypeUtils _Type_SSM_TR_State_Machine_Extend_Gear_Utils;
...
#endif /*ROB301_BRAMBILLA_GOMES_MTC_INST_TYPES_CONVERSION */
