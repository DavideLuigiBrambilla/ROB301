...
void Sub_Gears_Motion_Monitoring(
  ...
  outC_Sub_Gears_Motion_Monitoring *outC)
{
  ...
  kcg_bool _L22;
  /* MTC_sig_fire_5/, _L11/, _L18/, all_extended_true/ */
  kcg_bool MTC_sig_fire_5;
  /* @9/_/v4/ */
  kcg_int32 v4_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32;
  /* @5/MTC_CC_4/, _L17/, _L8/, all_retracted_true/ */
  kcg_bool MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;
  /* @5/v4/ */
  kcg_int32 v4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;

  outC->_15_Sub_Doors_Motion_Monitoring_state_sel =
    outC->Sub_Doors_Motion_Monitoring_state_nxt;
  _L29 = retract_extend_EV & (!outC->MTC_retract_extend_EV);
  MTC_sig_fire_5 = !(ctrl_status | gear_status_front | gear_status_right |
      gear_status_left);
  _L24 = !MTC_sig_fire_5;
  MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
    ctrl_status & gear_status_front & gear_status_right & gear_status_left;
  _L22 = ((!(ctrl_status &
          MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1)) &
      MTC_sig_fire_5) |
    (MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 &
  ...
  if (MTC_INSTRU) {
    ...
    LATCHALL03_MTC(
      ...
      _L29,
      (kcg_bool) !_L29,
      &outC->_9_Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS3_MTC_OBS_1);
    outC->_4_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS3_MTC_OBS_1 =
      outC->_9_Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS3_MTC_OBS_1.Output1;
    /* @13/MTC_ALL1=(MTC::LATCHALL03)/ */
    LATCHALL03_MTC(
      kcg_true,
      _L22,
      (kcg_bool) !_L22,
      &outC->_8_Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS4_MTC_OBS_1);
    outC->_3_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS4_MTC_OBS_1 =
      outC->_8_Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS4_MTC_OBS_1.Output1;
    ...
    LATCHALL03_MTC(
      ...
      (kcg_bool)
        !MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1,
      &outC->_7_Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS5_MTC_OBS_1);
    outC->_2_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS5_MTC_OBS_1 =
      outC->_7_Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS5_MTC_OBS_1.Output1;
    /* @15/MTC_ALL1=(MTC::LATCHALL03)/ */
    LATCHALL03_MTC(
      kcg_true,
      MTC_sig_fire_5,
      _L24,
      &outC->Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS6_MTC_OBS_1);
    outC->_1_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS6_MTC_OBS_1 =
      outC->Context_LATCHALL03_MTC_Sub_Gears_Motion_Monitoring_PATHS6_MTC_OBS_1.Output1;
    /* @17/MTC_ALL1=(MTC::LATCHALL02)/ */
    LATCHALL02_MTC(
      outC->init,
      (kcg_bool) !outC->init,
      &outC->Context_LATCHALL02_MTC_Sub_Gears_Motion_Monitoring_PATHS1_MTC_OBS_1_Sub_Gears_Motion_Monitoring_MTC_retract_extend_EV_last_MTC_INST_1);
    outC->MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS1_MTC_OBS_1_Sub_Gears_Motion_Monitoring_MTC_retract_extend_EV_last_MTC_INST_1 =
      outC->Context_LATCHALL02_MTC_Sub_Gears_Motion_Monitoring_PATHS1_MTC_OBS_1_Sub_Gears_Motion_Monitoring_MTC_retract_extend_EV_last_MTC_INST_1.Output1;
  }
  else {
    outC->_4_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS3_MTC_OBS_1 =
  ...
  switch (outC->_15_Sub_Doors_Motion_Monitoring_state_sel) {
    case SSM_st_WAITING_Sub_Doors_Motion_Monitoring :
      if (outC->Sub_Doors_Motion_Monitoring_reset_act) {
        ...
        LATCHALL04_MTC_reset(
          &outC->Context_LATCHALL04_MTC_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1);
      }
      /* @5/v4=, @9/_/v4= */
      if (outC->init6) {
        v4_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32 =
          duration;
        v4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
          duration;
      }
      else {
        v4_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32 =
          outC->v3_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32;
        v4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
          outC->v3_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;
      }
      /* @9/_/v3= */
      if (v4_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32 <
        kcg_lit_int32(0)) {
        outC->v3_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32 =
          v4_times_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1_int32;
      }
      ...
      MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
        ...
        kcg_lit_int32(0);
      /* @5/v3= */
      if (MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1) {
        outC->v3_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
          v4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1;
      }
      else {
      ...
      if (MTC_INSTRU) {
        ...
        LATCHALL04_MTC(
          ...
          MTC_CC_4_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1,
          &outC->Context_LATCHALL04_MTC_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1);
        outC->_5_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
          outC->Context_LATCHALL04_MTC_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1.Output1;
      }
      else {
        outC->_5_MTC_ALL1_Sub_Gears_Motion_Monitoring_PATHS2_MTC_OBS_1_Sub_Gears_Motion_Monitoring_Sub_Doors_Motion_Monitoring_WAITING_1_MTC_INST_1 =
          kcg_lit_Result_MTC(0);
    ...
    case SSM_st_NO_ANOMALY_Sub_Doors_Motion_Monitoring :
      outC->tr_1_clock_NO_ANOMALY_Sub_Doors_Motion_Monitoring = _L29;
      if (outC->Sub_Doors_Motion_Monitoring_reset_act) {
      ...
      outC->Sub_Doors_Motion_Monitoring_reset_act = _L29;
      break;
    default :
  ...
  outC->MTC_retract_extend_EV = retract_extend_EV;
}

#ifndef KCG_USER_DEFINED_INIT
void Sub_Gears_Motion_Monitoring_init(outC_Sub_Gears_Motion_Monitoring *outC)
{
  outC->Sub_Doors_Motion_Monitoring_reset_act = kcg_false;
  outC->MTC_retract_extend_EV = kcg_false;
  outC->gears_anomaly = kcg_true;
  outC->init = kcg_true;
  outC->init6 = kcg_true;
...
void Sub_Gears_Motion_Monitoring_reset(outC_Sub_Gears_Motion_Monitoring *outC)
{
  outC->Sub_Doors_Motion_Monitoring_reset_act = kcg_false;
  outC->MTC_retract_extend_EV = kcg_false;
  outC->init = kcg_true;
